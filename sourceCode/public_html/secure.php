...
<body <?php if($visited === FALSE):?> onload=' location.href="#home" '<?php endif; ?>>
  ...
  <div id="topBarMenu" class="topBarMenu">
      ...
      <?php if(isset($_SESSION["userLoggedin"]) && $_SESSION["userLoggedin"] == TRUE):?>
        ...
        <li><p style="background-color:darkcyan;border-radius:5px;text-align:center;"><a style="background-color:rgba(0,0,0,0);color:black;font-weight:bold;"><?php if(isset($_SESSION["username"])){echo ucwords($_SESSION["username"]);}?></a></p>
              ...
              <tbody>
                <form method="post">
                  <?php foreach ($_SESSION['library'] as $library1){ ?>
                    <tr>
                      <td><p id="libraryBookName"><?php echo $library1['bookName'];?> by <?php echo $library1['bookAuthor'];?></p></td>
